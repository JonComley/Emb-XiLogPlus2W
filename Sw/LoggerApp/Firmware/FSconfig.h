...
// Uncomment this to use the FSGetdiskProperties function
...
// Modified for custom file system MA.
#ifdef USE_SD_INTERFACE_WITH_SPI       // SD-SPI.c and .h

MEDIA_INFORMATION * CFS_sd_card_ready(void);				// prototype for CFS function

    #define MDD_MediaInitialize     CFS_sd_card_ready		// previously MDD_SDSPI_MediaInitialize
    ...
    #define MDD_InitIO()            //MDD_SDSPI_InitIO - not used
